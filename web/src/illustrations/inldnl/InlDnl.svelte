...
<main class="page">
  <header class="top">
    ...
    <Notes>
      <p><b>ADCToolbox.</b> The two estimators and the reference lines are ports of <a href="https://github.com/Arcadia-1/ADCToolbox">ADCToolbox</a> 0.9.1 — <code>compute_inl_from_ramp</code>, <code>compute_inl_from_sine</code> and <code>_correct_inl</code> — and agree with it to 0.01 LSB.</p>
